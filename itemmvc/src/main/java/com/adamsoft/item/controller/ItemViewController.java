...
public class ItemViewController {
	...
	/*
	 * // 파라미터 형태로 넘어오는 상세보기 요청처리
	 * 
	 * @RequestMapping(value="getitem", method=RequestMethod.GET) public String
	 * getItem (@RequestParam("itemid") Integer itemid,Model model){ // 필요한 서비스 메서드
	 * 호출
	 * 
	 * ItemDTO dto = itemService.getItem(itemid);
	 * 
	 * // 뷰에 데이터를 전달 model.addAttribute("item",dto); // 뷰이름 - ViewResolver 와 합쳐져서 실제
	 * 뷰가 결정 return "item/getitem"; }
	 */
